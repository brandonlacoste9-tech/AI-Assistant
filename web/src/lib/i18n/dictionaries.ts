...
const fr: Dictionary = {
  ...
  dashboard: {
    ...
    stats: {
      bookingsToday: "Coupes/Services",
      activeLeads: "Liste d'attente",
  ...
  onboarding: {
    ...
    subtitle: "Dites-nous ce que vous faites. On pré-remplit tout pour vous en quelques secondes.",
    step: "Étape",
    next: "Continuer",
    error: "Erreur — réessayez.",
    days: {
    ...
    hours: {
      ...
      subtitle: "Utilisées pour proposer des créneaux à vos clients.",
    },
    services: {
      title: "Vos services",
      subtitle: "Modifiez ou ajoutez les services que vous offrez. L'IA les utilisera pour prendre des rendez-vous.",
      name: "Nom du service",
      duration: "Durée (min)",
      price: "Prix ($)",
      ...
      subtitle:
        "Tout est configuré. Accédez à votre tableau de bord pour activer votre ligne téléphonique.",
      cta: "Accéder à mon tableau de bord",
    },
    businessTypes: {
      title: "Type d'entreprise",
      subtitle: "Choisissez le plus proche — vous pourrez personnaliser ensuite.",
      salon: "Salon de coiffure",
      salonDesc: "Coupe femme, balayage, coloration, soins.",
      trade: "Barbershop",
      tradeDesc: "Coupes hommes, dégradés, taille de barbe.",
      office: "Cabinet professionnel",
      officeDesc: "Droit, comptabilité, conseil, finance.",
    },
  },
  verticals: {
    label: "Pour qui",
...
const en: Dictionary = {
  ...
  dashboard: {
    ...
    stats: {
      bookingsToday: "Services today",
      activeLeads: "Waitlist",
  ...
  onboarding: {
    ...
    subtitle: "Tell us what you do and we'll pre-fill everything in seconds.",
    step: "Step",
    next: "Continue",
    error: "Error — please try again.",
    days: {
    ...
    hours: {
      ...
      subtitle: "Used to offer available time slots to your clients.",
    },
    services: {
      title: "Your services",
      subtitle: "Edit or add the services you offer. Your AI will use these to book appointments.",
      name: "Service name",
      ...
      subtitle:
        "Everything is configured. Head to your dashboard to activate your phone line.",
      cta: "Go to my dashboard",
    },
    businessTypes: {
      title: "Business type",
      subtitle: "Pick the closest match — you can customize everything after.",
      salon: "Hair Salon",
      salonDesc: "Women's cuts, balayage, color, and styling.",
      trade: "Barbershop",
      tradeDesc: "Fades, beard trims, and men's cuts.",
      office: "Professional Office",
      officeDesc: "Law, accounting, finance, consulting.",
    },
  },
  verticals: {
    label: "Who it's for",
